...
<main class="site-main">
            ...
            <div class="container programm-block">
                ...
                <div class="row gy-3 gx-md-3 row-cols-xl-3 row-cols-sm-2 row-cols-1">
                    <div class="programm-block__unit col">
                        <div class="d-flex ai-center mb-4">
                            ...
                            <div class="col-item"><small class="opacity-6">День 1</small>
                                <div class="h5"><b>От ручного управления до системной компании</b></div>
                            </div>
                        </div>
                        ...
                        <ul class="list-rhombus-small list-null">
                            <div class="h5"> <b>Ваш результат</b></div>
                            <li>Разберетесь, на каком этапе развития находится ваша компания и получите план перехода на следующую стадию</li>
                            <li>Получите реальную картину, сколько времени вы тратите на функции владельца, директора и специалиста</li>
                            <li>Определите функции владельца, которые вы упускаете и лишаете компанию роста</li>
                            <li>Получите эффективную модель взаимоотношений с совладельцами (партнёрами)</li>
                        </ul>
                    </div>
                    <div class="programm-block__unit col">
                        <div class="d-flex ai-center mb-4">
                            ...
                            <div class="col-item"><small class="opacity-6">День 2</small>
                                <div class="h5"><b>Оргсхема, найм и скорость роста</b></div>
                            </div>
                        </div>
                        <div class="programm-block__unit__more-information">
                            <div class="programm-block__unit__more-information__button">
                        ...
                        <ul class="list-rhombus-small list-null">
                            <div class="h5"> <b>Ваш результат</b></div>
                            <li>Сформулируете ценный конечный продукт вашей компании</li>
                            <li>Поймете, какой должна быть оргсхема и распределите функции текущих сотрудников</li>
                            <li>Найдете узкие места на оргсхеме компании и функции, которые не выполняются</li>
                            <li>Получите технологию быстрого найма</li>
                        </ul>
                    </div>
                    <div class="programm-block__unit col">
                        <div class="d-flex ai-center mb-4">
                            ...
                            <div class="col-item"><small class="opacity-6">День 3</small>
                                <div class="h5"><b>Система измерения результатов и их анализ</b></div>
                            </div>
                        </div>
                        <div class="programm-block__unit__more-information">
                            <div class="programm-block__unit__more-information__button">
                        ...
                        <ul class="list-rhombus-small list-null">
                            <div class="h5"> <b>Ваш результат</b></div>
                            <li>Поймете, как управлять бизнесом, основываясь на точных данных</li>
                            <li>Разберетесь, как измерять качественные и количественные результаты сотрудников на конкретных примерах (в том числе, для таких функциональных ролей как PR, HR, SMM, IT)</li>
                            <li>Получите инструмент, с помощью которого за 5 мин вы сможете безошибочно определять узкое место компании</li>
                    ...
                    <div class="programm-block__unit col">
                        ...
                        <ul class="list-rhombus-small list-null">
                            <div class="h5"> <b>Ваш результат</b></div>
                            <li>Поймете, почему неправильное планирование ведет к снижению результатов сотрудников при высокой загруженности</li>
                            <li>Научитесь внедрять недельные планы, которые повышают эффективность сотрудников в 2 раза</li>
                            <li>Получите готовые примеры планов на неделю</li>
                            <li>Определите ошибки, которые не позволяют вам эффективно использовать координации для быстрого достижения целей</li>
                        </ul>
                    </div>
                    <div class="programm-block__unit col">
                        <div class="d-flex ai-center mb-4">
                            ...
                            <div class="col-item"><small class="opacity-6">День 5</small>
                                <div class="h5"><b>Управление финансами</b></div>
                            </div>
                        </div>
                        <div class="programm-block__unit__more-information">
                            <div class="programm-block__unit__more-information__button">
                        ...
                        <ul class="list-rhombus-small list-null">
                            <div class="h5"> <b>Ваш результат</b></div>
                            <li>Получите схему разделения счетов, при которой вы никогда не уйдете в кассовый разрыв</li>
                            <li>Поймете, как передать ответственность за фин.планирование руководителям без риска нецелевого расходования средств</li>
                            <li>Разберете основные ошибки, которые мешают вам регулярно получать дивиденды</li>
                        </ul>
                    </div>
                    <div class="programm-block__unit col">
                        <div class="d-flex ai-center mb-4">
                            ...
                            <div class="col-item"><small class="opacity-6">День 6</small>
                                <div class="h5"><b>Как внедрять изменения</b></div>
                            </div>
                        </div>
                        <div class="programm-block__unit__more-information">
                            <div class="programm-block__unit__more-information__button">
                        ...
                        <ul class="list-rhombus-small list-null">
                            <div class="h5"> <b>Ваш результат</b></div>
                            <li>Определите, с чего начать внедрение инструментов управления, чтобы не столкнуться с саботажем сотрудников</li>
                            <li>Поймете, как избежать 99% ошибок внедрения системы управления</li>
                            <li>Разработаете план построения системы в бизнесе</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="section section--theme-yellow">
        ...
        <section class="section section--theme-dark" id="customer-cases">
            <div class="container">
                <div class="customer-cases">
                    <div class="h1">
                        Кейсы клиентов, прошедших <b><br>годовые консалтинговые программы </b>
                        <img src="images/cases/1-4.webp" alt="">
                    </div>
                    <div class="customer-cases__wrapper">
                        <div class="customer-cases__wrapper__block">
                            <div class="customer-cases__wrapper__block__unit">
                                <div class="customer-cases__wrapper__block__unit__hat">
                                    <img src="images/cases/1-1.webp" alt="">
                                    <div class="customer-cases__wrapper__block__unit__hat__text">
                                        <div class="h5"><b>Анатолий Тельбух</b></div>
                                        <div class="h6">Владелец компании TCO, <br> г. Харьков, Украина</div>
                                    </div>
                                </div>
                                <div class="customer-cases__wrapper__block__unit__before">
                                    <div class="h6"><b>Состояние на 2009 год</b></div>
                                    <ul>
                                        <li>
                                            <div class="div">
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M3.21128 5.00382C3.4326 2.97456 5.14642 1.4375 7.1877 1.4375H22.8104C25.1912 1.4375 27.045 3.50441 26.7868 5.87118L25.1741 20.6584C24.9528 22.6877 23.239 24.2247 21.1977 24.2247H5.57497C3.19416 24.2247 1.34042 22.1578 1.59854 19.7911L3.21128 5.00382Z" stroke="#E92020" stroke-width="2"/>
                                                    <rect x="10.623" y="6.17773" width="14.8334" height="2.83164" rx="0.75" transform="rotate(50.9761 10.623 6.17773)" fill="#E92020"/>
                                                    <rect width="14.8334" height="2.83164" rx="0.75" transform="matrix(-0.707107 0.707107 0.707107 0.707107 18.4365 6.58594)" fill="#E92020"/>
                                                </svg>
                                            </div>
                                            <div class="h6">15 сотрудников под ручным управлением</div>
                                        </li>
                                        <li>
                                            <div class="div">
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6">Дом был заложен в кредит под нужды бизнеса</div>
                                        </li>
                                        <li>
                                            <div class="div">
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6">Едва нашел деньги на прохождение годовой программы</div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="customer-cases__wrapper__block__unit__after">
                                    <div class="h6"><b>Результат после прохождения программы</b></div>
                                    <ul>
                                        <li>
                                            <div>
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M3.21128 5.07413C3.4326 3.04488 5.14642 1.50781 7.1877 1.50781H22.8104C25.1912 1.50781 27.045 3.57472 26.7868 5.94149L25.1741 20.7287C24.9528 22.758 23.239 24.2951 21.1977 24.2951H5.57497C3.19416 24.2951 1.34042 22.2281 1.59854 19.8614L3.21128 5.07413Z" stroke="#00C01F" stroke-width="2"/>
                                                    <path d="M12.6646 17.7783C12.54 17.9036 12.3701 17.9736 12.1935 17.9736C12.0169 17.9736 11.847 17.9036 11.7224 17.7783L7.95987 14.0139C7.56936 13.6232 7.56936 12.9899 7.95987 12.6L8.43102 12.1287C8.82153 11.738 9.45394 11.738 9.84445 12.1287L12.1935 14.4785L18.5409 8.12892C18.9314 7.73828 19.5645 7.73828 19.9544 8.12892L20.4255 8.60022C20.816 8.99086 20.816 9.62416 20.4255 10.0141L12.6646 17.7783Z" fill="#00C01F"/>
                                                </svg>
                                            </div>
                                            <div class="h6">Доход вырос <b>в 17 раз за 2 года</b> после внедрения системы управления</div>
                                        </li>
                                        <li>
                                            <div>
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6"><b>Сейчас компания № 1 в стране</b> по производству школьной мебели и досок</div>
                                        </li>
                                        <li>
                                            <div>
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6">Валовый доход <b>увеличивается ежегодно на 200–250%</b> по сравнению с предыдущим</div>
                                        </li>
                                        <li>
                                            <div>
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6">Оснащены <b>более 19000</b> учебных заведений Украины (в 1960 населенных пунктах), а также за рубежом</div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="customer-cases__wrapper__block__unit">
                                <div class="customer-cases__wrapper__block__unit__hat">
                                    <img src="images/cases/1-2.webp" alt="">
                                    <div class="customer-cases__wrapper__block__unit__hat__text">
                                        <div class="h5"><b>Ляйля Сапаргалиева</b></div>
                                        <div class="h6"> Владелец компании “Сорбент”, г.Усть- Каменогорск, Казахстан</div>
                                    </div>
                                </div>
                                <div class="customer-cases__wrapper__block__unit__before">
                                    <div class="h6"><b>Состояние на 2009 год</b></div>
                                    <ul>
                                        <li>
                                            ...
                                            <div class="h6">За дверью кабинета собиралась очередь из сотрудников. Все проблемы прилетали владельцу.</div>
                                        </li>
                                        <li>
                                            <div class="div">
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6">Самостоятельно занималась наймом сотрудников, проводила собеседования, тестирование и ввод в должность.</div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="customer-cases__wrapper__block__unit__after">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="h6">Руководители согласовывают недельные планы, расставляют приоритеты <b>и сами устраняют оперативные проблемы.</b></div>
                                        </li>
                                        <li>
                                            <div>
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6">Вырастила 3 заместителей директора <b>и отошла от 90% оперативки.</b></div>
                                        </li>
                                        <li>
                                            <div>
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6"><b>Сейчас сидит в тихом кабинете,</b> в то время как в коридоре сотрудники «гудят».</div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="customer-cases__wrapper__block__unit">
                                <div class="customer-cases__wrapper__block__unit__hat">
                                    <img src="images/cases/1-3.webp" alt="">
                                    <div class="customer-cases__wrapper__block__unit__hat__text">
                                        <div class="h5"><b>Андрей Платонов</b></div>
                                        <div class="h6">Владелец компании “Мылофф”, г. Москва, Россия</div>
                                    </div>
                                </div>
                                <div class="customer-cases__wrapper__block__unit__before">
                                    <div class="h6"><b>Состояние на 2009 год</b></div>
                                    <ul>
                                        <li>
                                            ...
                                            <div class="h6">Проходил разные курсы и читал книги по найму, но эффективность найма была очень низкая. </div>
                                        </li>
                                        <li>
                                            <div class="div">
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6">Сотрудники не выходили на работу, и процесс найма был длительным.</div>
                                        </li>
                                        <li>
                                            <div class="div">
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6">Не знал, откуда брать руководителей, текущие сотрудники, казалось, не смогут выполнять роль руководителя.</div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="customer-cases__wrapper__block__unit__after">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="h6">Начал выводить кандидатов на тестовую неделю <b>вместо долгих собеседований.</b></div>
                                        </li>
                                        <li>
                                            <div>
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6"><b>Решил проблему</b> постановки руководителей.</div>
                                        </li>
                                        <li>
                                            <div>
                                                <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="h6">Понял, что нужно <b>заниматься развитием текущей команды,</b> тогда она сможет без проблем управлять бизнесом.</div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <a class="btn btn--hover-black" href="#feedback" rel="modal:open">Хочу также</a>
                </div>
            </div>
        </section>
        <section class="section">
            ...
            <div class="container total">
                ...
                <div class="total__sum">
                    <div class="total__sum__unit">
                        <div class="h1"><b>87%</b></div>
                        <div class="h4">участников рекомендуют тренинг своим знакомым</div>
                    </div>
                    <div class="total__sum__unit">
                        <div class="h1"><b>195 000 000 руб</b></div>
                        <div class="h4">средний оборот наших клиентов за год</div>
                    </div>
                </div>
                <div class="total__way h2"><b>Узнайте, как попасть в «Высшую лигу»
                        <br>и выйти в бизнесе на новый уровень</b></div>
                <div class="total__reservation">
                    <a class="btn btn--hover-black" href="#feedback" rel="modal:open">Занять место на тренинге!</a>
                    <div class="h6">Количество мест ограничено. Оплатите сейчас, чтобы гарантировать себе участие и получить дополнительные бонусы</div>
                </div>
            </div>
        </section>
    </div>
